...
const translations = {
  he: {
    ...
    modal: {
      ...
      extraPatty: "תוספת קציצה",
      meatAdditions: "תוספת בשר",
      meatAdditionsMax: "מקסימום 100 גרם לתוספות בשר",
      ...
      sandwichSauceFullNote: "סנדוויץ' מלא – 6 רטבים חינם, כל רוטב נוסף ₪2",
      weightSauceBaseNote: "ב-200 גרם מקבלים 3 רטבים חינם",
      weightSauceExtraNote: "כל 100 גרם נוספים מוסיפים עוד 2 רטבים חינם",
      saucePrefix: "רוטב",
      ...
      portionSizeRequired: "בחר גודל מנה לפני ההוספה לעגלה",
      ...
      grams: "גרם",
      chooseSide: "בחר תוספת בצד",
      chooseSideSubtitle: "אפשר לבחור תוספת בצד או להמשיך בלי תוספת.",
      chooseDrink: "בחר שתייה",
      chooseDrinkSubtitle: "אפשר לבחור שתייה או להמשיך בלי שתייה.",
      choose: "בחר",
      selected: "נבחר",
      noThanks: "לא תודה",
      back: "חזרה",
      next: "הבא",
      addMealToCart: "הוסף לעגלה",
    ...
    cartPage: {
      ...
      storeCommentLabel: "הערה למסעדה",
      storeCommentPlaceholder: "הכנס הערה כללית למסעדה (לא חובה)",
      ...
      addressPlaceholder: "כתובת (רחוב, מספר בית, עיר)",
      addressNotesPlaceholder: "הערות למשלוח (קומה, כניסה, קוד שער)",
      backToCart: "חזרה לעגלה",
      chooseAddressAlert: "אנא בחר מיקום למשלוח על גבי המפה",
      deliveryFeeLabel: "דמי משלוח",
      dragPinHint: "ניתן לגרור את הסיכה או ללחוץ על המפה כדי לכוון את מיקום המשלוח",
      edit: "ערוך",
      editLoadError: "שגיאה בטעינת המוצר לעריכה",
      editUnsupported: "לא ניתן לערוך פריט זה",
      geoDenied: "לא ניתן היה לאתר את המיקום שלך",
      geoNotSupported: "המכשיר לא תומך באיתור מיקום",
      locating: "מאתר מיקום...",
      outOfRangeAlert: "מצטערים, הכתובת מחוץ לאזור המשלוח שלנו",
      sendingOrder: "שולח...",
      toCheckout: "להמשך לתשלום",
      useMyLocation: "השתמש במיקום שלי",
    },
    restaurantSettings: {
      openMenu: "פתח תפריט",
      title: "הגדרות מסעדה",
      subtitle: "מיקום המסעדה ואזורי משלוח",
      loadError: "שגיאה בטעינת נתוני המסעדה",
      restaurantNameTitle: "שם המסעדה",
      locationTitle: "מיקום המסעדה",
      locationDesc: "מיקום זה משמש כנקודת ההתייחסות של המסעדה על המפה.",
      locationInputLabel: "הדבק קישור מ-Google Maps (לחיצה ארוכה על המיקום ← שיתוף) או כתובת מלאה",
      locationInputPlaceholder: "https://maps.app.goo.gl/... או כתובת",
      findLocation: "מצא מיקום",
      findingLocation: "מחפש…",
      dragPinAfterFindHint: "לאחר שהסיכה תקפוץ למקום, אפשר עדיין לגרור אותה על המפה כדי לדייק.",
      locationFoundSuccess: "המיקום נמצא — ניתן לדייק ע\"י גרירת הסיכה על המפה",
      locationNotFoundError: "לא הצלחנו למצוא את המיקום הזה, נסה להזיז את הסיכה ידנית",
      restaurantLocationLegend: "מיקום המסעדה",
      zonesTitle: "אזורי משלוח",
      zonesDesc:
      ...
      zoneSearchPlaceholder: "חפש עיר או כפר (עברית / English / عربي)...",
      searching: "מחפש…",
      addingZone: "מוסיף את",
      noResults: "לא נמצאו תוצאות",
      noZonesYet: "עדיין לא הוגדרו אזורי משלוח.",
      removeZone: "הסר את",
      zoneBoundaryError: "לא הצלחנו למצוא את גבולות",
      selectLocationError: "אנא בחר את מיקום המסעדה על גבי המפה",
  ...
  en: {
    ...
    modal: {
      ...
      meatAdditions: "Meat add-ons",
      meatAdditionsMax: "Max 100g total for meat add-ons",
      addComment: "Add a note",
      commentPlaceholder: "Add a note (optional)",
      addToCart: "Add to cart",
      sauces: "Sauce additions",
      freeSauces: "Free",
      extraSaucePrice: "Each extra sauce ₪2",
      sandwichSauceHalfNote: "Half sandwich – 3 free sauces, each extra ₪2",
      sandwichSauceFullNote: "Full sandwich – 6 free sauces, each extra ₪2",
      weightSauceBaseNote: "At 200g you get 3 free sauces",
      weightSauceExtraNote: "Each additional 100g adds 2 more free sauces",
      saucePrefix: "Sauce",
      ...
      portionSizeRequired: "Please choose a portion size before adding to cart",
      ...
      chooseSideSubtitle: "Pick a side dish or choose no side.",
      chooseDrink: "Choose a drink",
      chooseDrinkSubtitle: "Pick a drink or choose no drink.",
      choose: "Choose",
      selected: "Selected",
      noThanks: "No thanks",
      back: "Back",
      next: "Next",
      addMealToCart: "Add to cart",
    ...
    cartPage: {
      ...
      storeCommentLabel: "Note to the restaurant",
      storeCommentPlaceholder: "Add a general note to the restaurant (optional)",
      ...
      addressPlaceholder: "Address (street, house number, city)",
      addressNotesPlaceholder: "Delivery notes (floor, entrance, gate code)",
      backToCart: "Back to cart",
      chooseAddressAlert: "Please choose a delivery location on the map",
      deliveryFeeLabel: "Delivery fee",
      dragPinHint: "Drag the pin or click the map to set the delivery location",
      edit: "Edit",
      editLoadError: "Error loading the item for editing",
      editUnsupported: "This item can't be edited",
      geoDenied: "We couldn't locate you",
      geoNotSupported: "Your device doesn't support location",
      locating: "Locating...",
      outOfRangeAlert: "Sorry, this address is outside our delivery area",
    ...
    restaurantSettings: {
      ...
      subtitle: "Restaurant location and delivery areas",
      loadError: "Error loading restaurant data",
      restaurantNameTitle: "Restaurant name",
      locationTitle: "Restaurant location",
      locationDesc: "This location is used as the restaurant's reference point on the map.",
      locationInputLabel: "Paste a Google Maps link (long-press location → share) or a full address",
      locationInputPlaceholder: "https://maps.app.goo.gl/... or an address",
      findLocation: "Find location",
      findingLocation: "Searching…",
      dragPinAfterFindHint: "Once the pin jumps to the spot, you can still drag it on the map to fine-tune it.",
      locationFoundSuccess: "Location found — you can fine-tune it by dragging the pin on the map",
      locationNotFoundError: "We couldn't find that location, try moving the pin manually",
      restaurantLocationLegend: "Restaurant location",
      zonesTitle: "Delivery areas",
      zonesDesc:
        "The restaurant's own settlement is added automatically on save. Add other cities/villages here that the restaurant delivers to. Any address outside these areas will be automatically blocked at checkout. The delivery fee is calculated automatically by distance — no need to enter a price.",
      zoneSearchPlaceholder: "Search a city or village (Hebrew / English / عربي)...",
      searching: "Searching…",
      addingZone: "Adding",
      noResults: "No results found",
      noZonesYet: "No delivery areas configured yet.",
      removeZone: "Remove",
      zoneBoundaryError: "We couldn't find the boundaries of",
      selectLocationError: "Please select the restaurant's location on the map",
      saveSuccess: "Changes saved successfully",
      saveError: "Error saving the data",
      saving: "Saving…",
