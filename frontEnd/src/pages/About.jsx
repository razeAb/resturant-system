      ...
      <div className="min-h-screen flex flex-col lg:flex-row justify-center items-center lg:px-32 px-5 pt-20">
        ...
        <div className="space-y-4 lg:pt-14 p-5 lg:w-1/2 w-full" style={ltrStyle}>
          ...
          <p>
            ...
            שימוש בחומרי גלם טריים ואיכותיים ומציעים גם תוספות ורטבים מקוריים המשלימים את חוויית האוכל. המשאית נמצאת במיקום נוח ומזמין,
            ומציעה שירות מהיר ואדיב לכל הלקוחות. בואו לטעום ולהתענג על מנות בשר מעושן כמו שלא הכרתם!
          </p>
